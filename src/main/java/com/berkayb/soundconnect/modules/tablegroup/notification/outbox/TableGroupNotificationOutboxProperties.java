...
@Setter
@Validated
@ConfigurationProperties(prefix = "app.notification.table-group-outbox")
public class TableGroupNotificationOutboxProperties {
	@Min(1) @Max(100)
	...
	@AssertTrue(message = "TableGroup notification outbox timing configuration is unsafe")
