...
@Setter
@Validated
@ConfigurationProperties(prefix = "app.notification.event-performer-outbox")
public class EventPerformerNotificationOutboxProperties {
	...
	@AssertTrue(message = "Event performer notification outbox timing configuration is unsafe")
