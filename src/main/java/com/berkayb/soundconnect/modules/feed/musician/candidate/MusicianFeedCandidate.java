...
public record MusicianFeedCandidate(
        ...
        MusicianFeedAnnouncementPlan.Entry announcementPlacement
) {
    public MusicianFeedCandidate(String itemId, MusicianFeedItemType type, int payloadVersion,
                                  Instant occurredAt, MusicianFeedItemResponse.Reason reason,
                                  MusicianFeedItemResponse.Author author, MusicianFeedItemResponse.Target target,
                                  MusicianFeedItemResponse.Engagement engagement, MusicianFeedItemResponse.Promotion promotion,
                                  List<MusicianFeedFeedbackAction> feedbackCapabilities, Object payload,
                                  long baseScore, int relevanceScore, MusicianFeedLane lane, boolean ownedByViewer) {
        this(itemId, type, payloadVersion, occurredAt, reason, author, target, engagement, promotion,
                feedbackCapabilities, payload, baseScore, relevanceScore, lane, ownedByViewer, null);
    }
